...
export default function Loop() {
  return (
    <section id="contact" className="loop">

      <div className="loop-content">
        <span className="loop-eyebrow">Get Involved</span>
        <h2 className="loop-heading">
          Stay in the loop, always.
        </h2>
        <p className="loop-sub">
          Subscribe to our newsletter and reach out anytime! We'd love to connect.
        </p>
      </div>

      {/* Wave stays unchanged */}
